        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BannedByUserId = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    IsActive = table.Column<bool>(type: "bit", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    UserId = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    TotalFraudFlags = table.Column<int>(type: "int", nullable: false),
                    HighSeverityCount = table.Column<int>(type: "int", nullable: false),
                    ActiveFraudCount = table.Column<int>(type: "int", nullable: false),
                    TotalRefundCount = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CargoDate = table.Column<DateTime>(type: "datetime2", nullable: true),
                    ...
                    CancelApproved = table.Column<bool>(type: "bit", nullable: false),
                    CancelRejected = table.Column<bool>(type: "bit", nullable: false),
                    CancelRequestedAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                    PaymentLogId = table.Column<int>(type: "int", nullable: true),
                    PaymentTransactionId = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    IsPaid = table.Column<bool>(type: "bit", nullable: false),
                    RefundOverrideEnabled = table.Column<bool>(type: "bit", nullable: false),
                    RefundOverrideNote = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    RefundOverrideAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                    RefundOverrideByUserId = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RetryLimitMailSent = table.Column<bool>(type: "bit", nullable: false),
                    PdfDownloaded = table.Column<bool>(type: "bit", nullable: false),
                    PdfDownloadedAt = table.Column<DateTime>(type: "datetime2", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_PartialRefunds", x => x.Id);
                    table.ForeignKey(
                        name: "FK_PartialRefunds_OrderItems_OrderItemId",
                        column: x => x.OrderItemId,
                        principalTable: "OrderItems",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_PartialRefunds_Orders_OrderId",
                        column: x => x.OrderId,
                        principalTable: "Orders",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PartialRefundId = table.Column<int>(type: "int", nullable: false),
                    Provider = table.Column<string>(type: "nvarchar(max)", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_RefundLogs_PartialRefunds_PartialRefundId",
                        column: x => x.PartialRefundId,
                        principalTable: "PartialRefunds",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_RefundLogs_PaymentLogs_PaymentLogId",
                        column: x => x.PaymentLogId,
                        principalTable: "PaymentLogs",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PartialRefunds_OrderId",
                table: "PartialRefunds",
                column: "OrderId");

            migrationBuilder.CreateIndex(
                name: "IX_PartialRefunds_OrderItemId",
                table: "PartialRefunds",
                column: "OrderItemId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RefundLogs_PartialRefundId",
                table: "RefundLogs",
                column: "PartialRefundId");

            migrationBuilder.CreateIndex(
                name: "IX_RefundLogs_PaymentLogId",
                table: "RefundLogs",
                column: "PaymentLogId");
